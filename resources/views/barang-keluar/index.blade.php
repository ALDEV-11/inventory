...
<head>
    ...
    <title>Barang Keluar - SmartStock</title>
    ...
    <div id="main">
        ...
        <div class="page-heading">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3>Barang Keluar</h3>
                    <p class="text-subtitle text-muted">Kelola pengeluaran barang ke tujuan/proyek</p>
                </div>
                <a href="{{ route('barang-keluar.create') }}" class="btn btn-primary px-4 py-2 shadow-sm fw-bold">
...
<div class="page-content">
    ...
    <div class="card shadow-sm border-0" style="border-radius: 12px;">
        <div class="card-header bg-white border-0 py-3">
            <form action="{{ route('barang-keluar.index') }}" method="GET" class="row g-2">
                <div class="col-md-4">
                    <div class="input-group">
                        <span class="input-group-text bg-light border-0"><i class="fas fa-search text-muted"></i></span>
                        <input type="text" name="search" id="searchInput" class="form-control bg-light border-0" placeholder="Cari No. Keluar atau Tujuan..." value="{{ $search }}" autocomplete="off">
                    </div>
                </div>
                <div class="col-md-2">
        ...
        <div id="table-container">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="ps-4"><span class="fw-bold">{{ $item->nomor_keluar }}</span></td>
                                ...
                                <td class="text-end pe-4">
                                    <a href="{{ route('barang-keluar.show', $item->id_keluar) }}" class="btn btn-sm btn-outline-info" title="Detail"><i class="fas fa-eye"></i> Detail</a>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    ...
                                    <p class="text-muted">Belum ada riwayat pengeluaran barang.</p>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="card-footer bg-white border-0 py-3">
                <div class="d-flex justify-content-between align-items-center">
                    <p class="small text-muted mb-0">Menampilkan {{ $barangKeluar->firstItem() ?: 0 }} - {{ $barangKeluar->lastItem() ?: 0 }} dari {{ $barangKeluar->total() }} data</p>
                    {{ $barangKeluar->appends(['search' => $search])->onEachSide(1)->links('pagination::bootstrap-5') }}
                </div>
            </div>
        </div>
    </div>
